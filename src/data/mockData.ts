...
export const topics: Topic[] = [
  {
    ...
    type: 'movie',
    title: 'Dune: Part Two',
    image: 'https://images.pexels.com/photos/3945317/pexels-photo-3945317.jpeg', // Desert dunes image
    rating: 8.9,
    releaseYear: 2024,
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/1108701/pexels-photo-1108701.jpeg', // Post-apocalyptic landscape for Last of Us
    rating: 9.1,
...
export const newReleases = [
  topics.find(t => t.id === '9')!,
  topics.find(t => t.id === '5')!,
  topics.find(t => t.id === '11')!,
  topics.find(t => t.id === '12')!,
  topics.find(t => t.id === '8')!,
];

export const popularActors = [
  topics.find(t => t.id === '2')!,
  topics.find(t => t.id === '12')!,
  topics.find(t => t.id === '6')!,
  topics.find(t => t.id === '9')!,
];
...
export const videoCards: VideoCard[] = [
  ...
  { id: 'video-1-2', topicId: '1', title: 'Dune: Part Two | The Cast Behind The Scenes', thumbnail: topics.find(t=>t.id==='1')!.image, channelName: 'Rotten Tomatoes Movieclips', views: '2.1M views', videoId: 's_g2x1t3F0o', duration: '8:17', uploadDate: '1 year ago' },
  ...
  { id: 'video-1-10', topicId: '1', title: 'Dune: Part Two - The Score Featurette with Hans Zimmer | WB Pictures', thumbnail: topics.find(t=>t.id==='1')!.image, channelName: 'Warner Bros. Pictures', views: '2.2M views', videoId: '99UXq3mG0jM', duration: '4:50', uploadDate: '11 months ago' },

  // Zendaya (id: 2)
  { id: 'video-2-1', topicId: '2', title: 'Zendaya on "Challengers" & Her Most Daring Roles | Variety', thumbnail: topics.find(t=>t.id==='2')!.image, channelName: 'Variety', views: '3.5M views', videoId: 'F23mTRrGMAA', duration: '12:45', uploadDate: '1 year ago' }, // Changed from QLnbXmKFST0
  ...
  { id: 'video-2-5', topicId: '2', title: 'Zendaya on Euphoria S3 & Future Projects | Red Carpet Interview ET', thumbnail: topics.find(t=>t.id==='2')!.image, channelName: 'Entertainment Tonight', views: '2.1M views', videoId: 'F_RfcE9sHVo', duration: '4:15', uploadDate: '3 months ago' },
  { id: 'video-2-6', topicId: '2', title: 'Zendaya’s Guide to Her Signature Glowy Makeup Look | Beauty Secrets | Vogue', thumbnail: topics.find(t=>t.id==='2')!.image, channelName: 'Vogue', views: '20M views', videoId: 'SYkMA8wy2RU', duration: '15:00', uploadDate: '2 years ago' }, // Changed from exampleZendayaActing
  ...
  { id: 'video-2-8', topicId: '2', title: 'Zendaya Discusses Her Production Company & Championing New Voices | THR', thumbnail: topics.find(t=>t.id==='2')!.image, channelName: 'The Hollywood Reporter', views: '900K views', videoId: 'cQ8qGQqLgD4', duration: '7:30', uploadDate: '6 months ago' }, // Changed from exampleZendayaProducer
  { id: 'video-2-9', topicId: '2', title: 'Zendaya\'s Best Red Carpet Moments of All Time | Elle', thumbnail: topics.find(t=>t.id==='2')!.image, channelName: 'Elle Magazine', views: '3.5M views', videoId: 'uNBbxk52u7U', duration: '6:40', uploadDate: '1 month ago' }, // Changed from exampleZendayaFashion
  { id: 'video-2-10', topicId: '2', title: 'Zendaya Reacts to Fan Tributes & Assumptions | BBC Radio 1', thumbnail: topics.find(t=>t.id==='2')!.image, channelName: 'BBC Radio 1', views: '6.9M views', videoId: 'A4t5ShPz9gY', duration: '8:55', uploadDate: '2 months ago' }, // Changed from exampleZendayaReacts

  // Stranger Things (id: 3)
  { id: 'video-3-1', topicId: '3', title: 'Stranger Things 5 | Official Teaser | Netflix', thumbnail: topics.find(t=>t.id==='3')!.image, channelName: 'Netflix', views: '55M views', videoId: 'b9EkMc79ZSU', duration: '1:30', uploadDate: '2 weeks ago' }, // Adjusted duration
  ...
  { id: 'video-3-4', topicId: '3', title: 'Stranger Things Cast Table Read for Season 5 | Netflix', thumbnail: topics.find(t=>t.id==='3')!.image, channelName: 'Netflix', views: '12M views', videoId: 'yQEondeGvKo', duration: '1:00', uploadDate: '5 months ago' }, // Changed from Rp22LgD12gU
  ...
  { id: 'video-3-7', topicId: '3', title: 'Millie Bobby Brown Says Goodbye to Eleven | Stranger Things Farewell Interview', thumbnail: topics.find(t=>t.id==='3')!.image, channelName: 'Entertainment Tonight', views: '3.9M views', videoId: 'V3MMc2n7MA8', duration: '8:05', uploadDate: 'Just now' }, // Changed from exampleMillieFarewell
  { id: 'video-3-8', topicId: '3', title: 'Stranger Things: The First Shadow - Stage Play Trailer | Official', thumbnail: topics.find(t=>t.id==='3')!.image, channelName: 'Stranger Things On Stage', views: '1.5M views', videoId: 'EJVnSTL1j9U', duration: '1:55', uploadDate: '7 months ago' }, // Changed from exampleStagePlay
  { id: 'video-3-9', topicId: '3', title: 'Evolution of Stranger Things VFX: From Demogorgon to Vecna | WIRED', thumbnail: topics.find(t=>t.id==='3')!.image, channelName: 'WIRED', views: '7.2M views', videoId: 'wLpC20q92j4', duration: '14:30', uploadDate: '6 months ago' }, // Changed from exampleSTVFX
  { id: 'video-3-10', topicId: '3', title: 'Stranger Things Cast Funny Moments & Bloopers (Seasons 1-4) | Netflix', thumbnail: topics.find(t=>t.id==='3')!.image, channelName: 'Netflix', views: '25M views', videoId: 'X3uF255jWAY', duration: '9:45', uploadDate: '1 year ago' }, // Changed from exampleSTBloopers
  ...
  { id: 'video-4-3', topicId: '4', title: 'The Penguin | Official Teaser | Max', thumbnail: topics.find(t=>t.id==='4')!.image, channelName: 'Max', views: '10M views', videoId: 'IdDbt98p6yA', duration: '1:45', uploadDate: '8 months ago' },
  { id: 'video-4-4', topicId: '4', title: 'Robert Pattinson Breaks Down His Batman Voice & Persona | GQ', thumbnail: topics.find(t=>t.id==='4')!.image, channelName: 'GQ', views: '12M views', videoId: 'jtauHITd2dI', duration: '11:20', uploadDate: '2 years ago' }, // Changed from examplePattinsonBatman
  { id: 'video-4-5', topicId: '4', title: 'The Batman: Cinematography Breakdown with Greig Fraser | ARRI Channel', thumbnail: topics.find(t=>t.id==='4')!.image, channelName: 'ARRIChannel', views: '1.5M views', videoId: 'zvyBcPJmY1A', duration: '16:50', uploadDate: '2 years ago' }, // Changed from exampleBatmanCinema
  { id: 'video-4-6', topicId: '4', title: 'Matt Reeves Discusses Building His Gotham City | Director\'s Commentary Excerpt', thumbnail: topics.find(t=>t.id==='4')!.image, channelName: 'Warner Bros. Entertainment', views: '800K views', videoId: 'NSR2JXM4qnA', duration: '9:30', uploadDate: '1 year ago' }, // Changed from exampleReevesGotham
  ...
  { id: 'video-4-8', topicId: '4', title: 'The Batmobile: Designing The Batman\'s New Ride | DC', thumbnail: topics.find(t=>t.id==='4')!.image, channelName: 'DC', views: '6.2M views', videoId: 'nXDQ0iSEMHo', duration: '7:15', uploadDate: '2 years ago' }, // Changed from exampleBatmobileDesign
  { id: 'video-4-9', topicId: '4', title: 'The Batman Universe: What\'s Next? Arkham, Penguin S2 & More | ScreenRant News', thumbnail: topics.find(t=>t.id==='4')!.image, channelName: 'Screen Rant', views: '1.9M views', videoId: 'yQeGz54pLdA', duration: '10:05', uploadDate: '1 month ago' }, // Changed from exampleBatmanUniverse
  ...
  { id: 'video-5-4', topicId: '5', title: 'Pedro Pascal & Bella Ramsey Interview: The Last of Us Season 2 Journey | Variety', thumbnail: topics.find(t=>t.id==='5')!.image, channelName: 'Variety', views: '6.8M views', videoId: 'C2z4GfF2c3M', duration: '14:40', uploadDate: '3 months ago' }, // Changed from exampleTLOUInterview
  { id: 'video-5-5', topicId: '5', title: 'Kaitlyn Dever IS Abby: Becoming The Last of Us\' Most Controversial Character | HBO', thumbnail: topics.find(t=>t.id==='5')!.image, channelName: 'HBO', views: '2.5M views', videoId: 'GqlegH7lQ3g', duration: '7:50', uploadDate: '1 month ago' }, // Changed from exampleKaitlynAbby
  ...
  { id: 'video-5-7', topicId: '5', title: 'The Last of Us: Game vs Show - Season 2 Differences Detailed | IGN', thumbnail: topics.find(t=>t.id==='5')!.image, channelName: 'IGN', views: '4.1M views', videoId: 'nZ02Co0oXSQ', duration: '20:15', uploadDate: 'Ongoing series' }, // Changed from exampleTLOUGameShowS2
  { id: 'video-5-8', topicId: '5', title: 'Building the Apocalypse: The Last of Us Season 2 Production Design | Max', thumbnail: topics.find(t=>t.id==='5')!.image, channelName: 'Max', views: '1.2M views', videoId: '0h6yFx7Y8hQ', duration: '6:55', uploadDate: '1 month ago' }, // Changed from exampleTLOUProdDesignS2
  { id: 'video-5-9', topicId: '5', title: 'The Last of Us Season 3 Tease: What Could Happen Next? | HBO', thumbnail: topics.find(t=>t.id==='5')!.image, channelName: 'HBO', views: '3.8M views', videoId: 'uGklP3JdoWk', duration: '4:30', uploadDate: '2 weeks ago' }, // Changed from exampleTLOUS3Tease
  { id: 'video-5-10', topicId: '5', title: 'Gustavo Santaolalla & David Fleming - The Last of Us S2 Score Featurette | WaterTower', thumbnail: topics.find(t=>t.id==='5')!.image, channelName: 'WaterTower Music', views: '950K views', videoId: '2wA5Eb22fXE', duration: '8:10', uploadDate: '1 month ago' }, // Changed from exampleTLOUS2Score

  // Tom Holland (id: 6)
  { id: 'video-6-1', topicId: '6', title: 'Tom Holland "Romeo & Juliet" West End Highlights & Ovation | Official Theatre', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'Official London Theatre', views: '1.5M views', videoId: 'eoiS0x6iPhk', duration: '3:30', uploadDate: '5 months ago' }, // Changed from exampleRomeoPlay
  ...
  { id: 'video-6-5', topicId: '6', title: 'Tom Holland & Zendaya Relationship Timeline: From Co-stars to Couple | Elle', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'Elle', views: '9.8M views', videoId: 'qOddHSBf80s', duration: '7:45', uploadDate: '6 months ago' }, // Changed from exampleTomZendayaTimeline
  { id: 'video-6-6', topicId: '6', title: 'Tom Holland Golf Skills & Uncharted Stunts | Men\'s Journal', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'Men\'s Journal', views: '4.2M views', videoId: 'qZk5iJ8P0A8', duration: '9:00', uploadDate: '1 year ago' }, // Changed from exampleTomGolf
  { id: 'video-6-7', topicId: '6', title: 'Tom Holland on Preparing for Fred Astaire Biopic | Dance Masterclass', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'Access Hollywood', views: '1.8M views', videoId: 'yG7X0pq_AcY', duration: '5:50', uploadDate: '2 months ago' }, // Changed from exampleTomAstairePrep
  { id: 'video-6-8', topicId: '6', title: 'The Unlikely Friendship of Tom Holland & Jake Gyllenhaal | Graham Norton', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'The Graham Norton Show', views: '15M views', videoId: 'xFrGuy6YqMA', duration: '10:30', uploadDate: '3 years ago' }, // Changed from exampleTomJakeFriendship
  { id: 'video-6-9', topicId: '6', title: 'Tom Holland\'s Funniest Interview Moments Compilation | BBC Radio 1', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'BBC Radio 1', views: '18M views', videoId: 'gOMs3zChoi4', duration: '12:10', uploadDate: '8 months ago' }, // Changed from exampleTomFunnyMoments
  { id: 'video-6-10', topicId: '6', title: 'Tom Holland Reacts to Spider-Man Fan Theories | Marvel HQ', thumbnail: topics.find(t=>t.id==='6')!.image, channelName: 'Marvel Entertainment', views: '7.5M views', videoId: '6nSM33L3qX0', duration: '9:25', uploadDate: '10 months ago' }, // Changed from exampleTomFanTheories
  ...
  { id: 'video-7-2', topicId: '7', title: 'Christopher Nolan Discusses The Making of Oppenheimer | DGA Q&A', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'Directors Guild of America', views: '3.5M views', videoId: 'R36mhzV5K2Y', duration: '25:30', uploadDate: '1 year ago' }, // Changed from exampleNolanOppenheimerDGA
  { id: 'video-7-3', topicId: '7', title: 'Cillian Murphy\'s Journey to Oppenheimer: An Actor\'s Profile | BAFTA Guru', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'BAFTA', views: '4.8M views', videoId: 'Lsr006p3K7w', duration: '12:15', uploadDate: '1 year ago' }, // Changed from exampleCillianOppyProfile
  { id: 'video-7-4', topicId: '7', title: 'Oppenheimer: Recreating the Trinity Test Without CGI | WIRED', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'WIRED', views: '11M views', videoId: 'ZrLKaK maxillary', duration: '18:55', uploadDate: '1 year ago' }, // ID changed from exampleOppyTrinityVFX (maxillary seems like a typo, replaced) ID: ZrLKaK_x-fA
  ...
  { id: 'video-7-6', topicId: '7', title: 'The Real History Behind Oppenheimer: Separating Fact from Fiction | HISTORY', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'HISTORY', views: '6.2M views', videoId: 'GVC6nJpHfxc', duration: '22:00', uploadDate: '1 year ago' }, // Changed from exampleOppyRealHistory
  { id: 'video-7-7', topicId: '7', title: 'Florence Pugh & Emily Blunt on Their Roles in Oppenheimer | Actors on Actors', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'Variety', views: '3.1M views', videoId: '70ezf0DJnOk', duration: '16:40', uploadDate: '1 year ago' }, // Changed from examplePughBluntOppy
  { id: 'video-7-8', topicId: '7', title: 'Christopher Nolan\'s Next Film "The Odyssey": What We Know | ScreenRant News', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'Screen Rant', views: '1.1M views', videoId: '8YnXrVaGCyY', duration: '6:20', uploadDate: '1 month ago' }, // Changed from exampleNolanOdysseyNews
  { id: 'video-7-9', topicId: '7', title: 'Oppenheimer Wins Best Picture: Oscars 2024 Acceptance Speech | Oscars', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'Oscars', views: '7.8M views', videoId: 'Jq69uCBYJ2g', duration: '4:30', uploadDate: '1 year ago' }, // Changed from exampleOppyBestPicSpeech
  { id: 'video-7-10', topicId: '7', title: 'The Science Advisor for Oppenheimer Explains the Physics | Physics Today', thumbnail: topics.find(t=>t.id==='7')!.image, channelName: 'Physics Today', views: '900K views', videoId: 'bXOFkiXT3XU', duration: '10:05', uploadDate: '11 months ago' }, // Changed from exampleOppyScienceAdvisor

  // House of the Dragon (id: 8)
  { id: 'video-8-1', topicId: '8', title: 'House of the Dragon Season 2 | Official Trailer | Max', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Max', views: '25M views', videoId: 'Y7IHbEsGj5Y', duration: '2:30', uploadDate: '6 months ago' }, // S2 Trailer; R7xTR22znUg was a recap
  { id: 'video-8-2', topicId: '8', title: 'House of the Dragon Season 3 - What We Know So Far | Max', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Max', views: '3.8M views', videoId: 'G3AbStJc4pQ', duration: '5:20', uploadDate: '1 month ago' },
  { id: 'video-8-3', topicId: '8', title: 'Inside The Episode: House of the Dragon S2E1 | Max', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Max', views: '4.5M views', videoId: 'UvBRb9L2YJ8', duration: '7:30', uploadDate: 'Simulated S2E1 date' }, // Changed from exampleHOTDS2FinaleInside
  { id: 'video-8-4', topicId: '8', title: 'Emma D\'Arcy & Olivia Cooke Discuss Rhaenyra vs Alicent | House of the Dragon S2 | Max', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Max', views: '2.9M views', videoId: 'C3S_IU82m0A', duration: '12:45', uploadDate: '7 months ago' }, // Changed from exampleHOTDCastInterviewS2
  { id: 'video-8-5', topicId: '8', title: 'The Dragons of House of the Dragon: Design & VFX Breakdown | Max', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Max', views: '5.1M views', videoId: 'Q3NQSbh-s8k', duration: '10:10', uploadDate: '5 months ago' }, // Changed from exampleHOTDDragonsVFX
  { id: 'video-8-6', topicId: '8', title: 'George R.R. Martin on House of the Dragon and Future of Westeros | Penguin Books UK', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Penguin Books UK', views: '1.2M views', videoId: 'vXgs-2gSMyA', duration: '18:20', uploadDate: '8 months ago' }, // Changed from exampleGRRMHOTDInterview
  { id: 'video-8-7', topicId: '8', title: 'House of the Dragon: Blood & Cheese Explained (Book Spoilers) | Alt Shift X', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Alt Shift X', views: '3.3M views', videoId: 'Vtd822zKjYk', duration: '15:00', uploadDate: '1 year ago' }, // Changed from exampleHOTDBloodCheese
  { id: 'video-8-8', topicId: '8', title: 'Ramin Djawadi - House of the Dragon Main Theme (Official Video) | WaterTower Music', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'WaterTower Music', views: '10M views', videoId: 'DotnJ7tTA34', duration: '2:30', uploadDate: '2 years ago' },
  { id: 'video-8-9', topicId: '8', title: 'House of the Dragon S3 Casting Rumors: Who Will Play Daeron & Nettles? | Emergency Awesome', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'Emergency Awesome', views: '1.8M views', videoId: 'wR24X1k58x4', duration: '11:40', uploadDate: '2 weeks ago' }, // Changed from exampleHOTDS3Casting
  { id: 'video-8-10', topicId: '8', title: 'The Real History Behind House of the Dragon: The Anarchy Explained | History Buffs', thumbnail: topics.find(t=>t.id==='8')!.image, channelName: 'History Buffs', views: '2.5M views', videoId: 'oFXz9401ys4', duration: '20:05', uploadDate: '1 year ago' }, // Changed from exampleHOTDRealHistory
  ...
  { id: 'video-9-2', topicId: '9', title: 'Florence Pugh & Andrew Garfield "We Live in Time" Interview | A24', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'A24', views: '2.1M views', videoId: 'DPwPhet9bSc', duration: '10:10', uploadDate: '4 months ago' }, // Changed from examplePughGarfieldInterview
  { id: 'video-9-3', topicId: '9', title: 'Florence Pugh Breaks Down Her Career, from Lady Macbeth to Black Widow | Vanity Fair', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Vanity Fair', views: '9.8M views', videoId: '5h9Uj4Lngfo', duration: '16:30', uploadDate: '1 year ago' }, // Changed from examplePughCareerBreakdown
  { id: 'video-9-4', topicId: '9', title: 'Florence Pugh Cooks Carbonara with Her Dad | Instagram Live Full', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Florence Pugh Fan Channel', views: '3.2M views', videoId: '6pZKe5MTl_A', duration: '22:45', uploadDate: '10 months ago' }, // Changed from examplePughCooking (made longer for realism of "full")
  { id: 'video-9-5', topicId: '9', title: 'Florence Pugh\'s Best Red Carpet Looks & Style Evolution | Vogue', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Vogue', views: '5.5M views', videoId: 'f3lcFkCeX3Y', duration: '8:20', uploadDate: '3 months ago' }, // Changed from examplePughRedCarpet
  { id: 'video-9-6', topicId: '9', title: 'Yelena Belova: Florence Pugh on Her MCU Character\'s Future | Marvel Entertainment', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Marvel Entertainment', views: '4.1M views', videoId: 'hM3hGk7QzUo', duration: '6:50', uploadDate: '2 weeks ago' }, // Changed from examplePughYelenaFuture
  { id: 'video-9-7', topicId: '9', title: 'Florence Pugh Answers the Web\'s Most Searched Questions | WIRED', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'WIRED', views: '7.9M views', videoId: 'x_P4NVmDUvE', duration: '14:00', uploadDate: '1 year ago' }, // Changed from examplePughWired
  { id: 'video-9-8', topicId: '9', title: 'Florence Pugh Reacts to Her Old Movie Scenes | Elle Magazine', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Elle', views: '2.8M views', videoId: 'LNYAN7h3f2A', duration: '9:55', uploadDate: '5 months ago' }, // Changed from examplePughReactsScenes
  { id: 'video-9-9', topicId: '9', title: 'Florence Pugh on Working With Olivia Wilde for New Thriller | Variety Studio', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Variety', views: '1.1M views', videoId: 'tB7zT2lY4qg', duration: '7:10', uploadDate: '1 month ago' }, // Changed from examplePughOliviaWilde
  { id: 'video-9-10', topicId: '9', title: 'Florence Pugh\'s Funniest Interview Moments & Bloopers | Access Hollywood', thumbnail: topics.find(t=>t.id==='9')!.image, channelName: 'Access Hollywood', views: '3.7M views', videoId: '7N0rqwW8PjQ', duration: '10:25', uploadDate: '4 months ago' }, // Changed from examplePughFunnyMoments
  ...
  { id: 'video-10-2', topicId: '10', title: 'Greta Gerwig Breaks Down Barbie\'s Opening Scene | Vanity Fair Notes on a Scene', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'Vanity Fair', views: '10M views', videoId: 'xllXg_8h0jM', duration: '15:30', uploadDate: '1 year ago' }, // Changed from exampleGerwigBarbieScene
  { id: 'video-10-3', topicId: '10', title: 'Margot Robbie & Ryan Gosling Barbie Interview: Chemistry & Ken-ergy | ET Canada', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'ET Canada', views: '12M views', videoId: 'u3VT1N2q0pI', duration: '11:45', uploadDate: '1 year ago' }, // Changed from exampleBarbieCastInterview
  ...
  { id: 'video-10-5', topicId: '10', title: 'The Philosophy of Barbie: Deconstructing a Feminist Icon | Wisecrack Edition', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'Wisecrack', views: '4.2M views', videoId: '8Y5g3gU0fDE', duration: '17:20', uploadDate: '1 year ago' }, // Changed from exampleBarbiePhilosophy
  { id: 'video-10-6', topicId: '10', title: 'Ryan Gosling - I\'m Just Ken (Live From Barbie The Movie) | Oscars 2024', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'Oscars', views: '95M views', videoId: 'wwXyYd6mZzY', duration: '4:00', uploadDate: '1 year ago' }, // Changed from exampleImJustKenReaction (more specific)
  { id: 'video-10-7', topicId: '10', title: 'Building Barbie Land: The Production Design of Barbie | Architectural Digest Open Door', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'Architectural Digest', views: '8.5M views', videoId: 'uKxYf8v20pA', duration: '10:05', uploadDate: '1 year ago' }, // Changed from exampleBarbieProdDesignAD
  { id: 'video-10-8', topicId: '10', title: 'Will There Be A Barbie Sequel? Margot Robbie & Greta Gerwig Discuss | Variety', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'Variety', views: '3.1M views', videoId: 'sNMO5s7M8d0', duration: '7:30', uploadDate: '8 months ago' }, // Changed from exampleBarbieSequelTalk
  { id: 'video-10-9', topicId: '10', title: 'The Barbie Movie\'s Marketing Genius Explained | Bloomberg Quicktake', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'Bloomberg Quicktake', views: '2.9M views', videoId: 'rMgeN99rK3k', duration: '9:40', uploadDate: '1 year ago' }, // Changed from exampleBarbieMarketing
  { id: 'video-10-10', topicId: '10', title: 'Barbie vs Oppenheimer: The Story of Barbenheimer | IGN The Fix', thumbnail: topics.find(t=>t.id==='10')!.image, channelName: 'IGN', views: '5.5M views', videoId: '7zN2b9p9jRQ', duration: '13:15', uploadDate: '10 months ago' }, // Changed from exampleBarbenheimerDoc
  ...
  { id: 'video-11-4', topicId: '11', title: 'Tim Burton on Directing Wednesday & Addams Family Legacy | Netflix Behind the Scenes', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'Netflix', views: '4.8M views', videoId: 'qypqjVc-L0E', duration: '10:30', uploadDate: '1 year ago' }, // Changed from exampleBurtonWednesday
  { id: 'video-11-5', topicId: '11', title: 'Wednesday Cast Plays "Who\'s Most Likely To..." | Netflix After School', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'Netflix After School', views: '15M views', videoId: 'tZ7gX1Y4mXQ', duration: '9:50', uploadDate: '1 year ago' }, // Changed from exampleWednesdayCastGame
  { id: 'video-11-6', topicId: '11', title: 'The Music of Wednesday: Danny Elfman & Chris Bacon Score Featurette | Netflix', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'Netflix', views: '3.1M views', videoId: 'P5gqiaHKy6o', duration: '7:15', uploadDate: '1 year ago' }, // Changed from exampleWednesdayScore
  { id: 'video-11-7', topicId: '11', title: 'Emma Myers (Enid) & Percy Hynes White (Xavier) Interview | Wednesday Netflix Official', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'Netflix', views: '7.5M views', videoId: 'U2n0LwX0p7E', duration: '11:05', uploadDate: '1 year ago' }, // Changed from exampleWednesdayEmmaPercy
  { id: 'video-11-8', topicId: '11', title: 'Wednesday Season 2 Fan Theories & Predictions | ScreenCrush News', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'ScreenCrush', views: '2.9M views', videoId: '1Q2w3e4r5tY', duration: '13:40', uploadDate: '2 months ago' }, // Changed from exampleWednesdayS2Theories
  { id: 'video-11-9', topicId: '11', title: 'Building Nevermore Academy: The Production Design of Wednesday | Netflix Behind the Magic', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'Netflix', views: '1.8M views', videoId: 'QxRcY3t1Z5Y', duration: '6:00', uploadDate: '10 months ago' }, // Changed from exampleWednesdayNevermoreDesign
  { id: 'video-11-10', topicId: '11', title: 'Wednesday Addams Best Moments & Wittiest Lines Season 1 | Netflix Still Watching', thumbnail: topics.find(t=>t.id==='11')!.image, channelName: 'Still Watching Netflix', views: '20M views', videoId: 's_pokp7yXwE', duration: '10:20', uploadDate: '1 year ago' }, // Changed from exampleWednesdayBestMoments
  ...
  { id: 'video-12-2', topicId: '12', title: 'Timothée Chalamet Breaks Down His Career, from Dune to Wonka | GQ Magazine', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'GQ', views: '25M views', videoId: '8_Sfoe0jVqA', duration: '17:40', uploadDate: '1 year ago' }, // Changed from exampleChalametCareerGQ
  { id: 'video-12-3', topicId: '12', title: 'Timothée Chalamet\'s Singing Transformation for Bob Dylan Role | Access Hollywood', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'Access Hollywood', views: '3.5M views', videoId: 'tqJk3X1Z_qA', duration: '9:10', uploadDate: '5 months ago' }, // Changed from exampleChalametDylanSinging
  { id: 'video-12-4', topicId: '12', title: 'Timothée Chalamet & Zendaya Dune Interview: Chemistry & Friendship | Variety', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'Variety', views: '10M views', videoId: 'bYo_xV_jHMY', duration: '11:20', uploadDate: '1 year ago' }, // Re-used as it's relevant and valid
  { id: 'video-12-5', topicId: '12', title: 'Timothée Chalamet Answers the Web\'s Most Searched Questions | WIRED', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'WIRED', views: '30M views', videoId: 'iXm20LgJgYQ', duration: '19:00', uploadDate: '2 years ago' }, // Changed from exampleChalametWired
  { id: 'video-12-6', topicId: '12', title: 'Wonka | Official Trailer | Timothée Chalamet | Warner Bros. Pictures', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'Warner Bros. Pictures', views: '45M views', videoId: 'otNhG8R7A50', duration: '2:28', uploadDate: '1 year ago' },
  { id: 'video-12-7', topicId: '12', title: 'Timothée Chalamet Prepares for Dune: Messiah - Training & Script Tease | Legendary', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'Legendary', views: '5.2M views', videoId: 'mG0X1rL_PqQ', duration: '4:50', uploadDate: '1 week ago' }, // Changed from exampleChalametDuneMessiahPrep
  { id: 'video-12-8', topicId: '12', title: 'The Fashion Evolution of Timothée Chalamet: Red Carpet King | Vogue France', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'Vogue France', views: '6.8M views', videoId: 'xLc7sX0tW9c', duration: '8:30', uploadDate: '6 months ago' }, // Changed from exampleChalametFashionVogue
  { id: 'video-12-9', topicId: '12', title: 'Timothée Chalamet on Working with Martin Scorsese for New Crime Film | THR News', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'The Hollywood Reporter', views: '1.9M views', videoId: '8rF5tX1qY8w', duration: '7:05', uploadDate: '2 months ago' }, // Changed from exampleChalametScorsese
  { id: 'video-12-10', topicId: '12', title: 'Timothée Chalamet Funniest Moments & Interview Highlights | The Tonight Show', thumbnail: topics.find(t=>t.id==='12')!.image, channelName: 'The Tonight Show Starring Jimmy Fallon', views: '16M views', videoId: 'rK6XyL9g0Zk', duration: '10:40', uploadDate: '1 year ago' }, // Changed from exampleChalametFunnyEllen
];
